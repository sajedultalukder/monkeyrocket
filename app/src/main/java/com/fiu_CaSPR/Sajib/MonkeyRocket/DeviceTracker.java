...
public class DeviceTracker {
    ...
    public static final class Request {
         ...
         *
         * @param callback
         *     the callback to retrieve the {@link DeviceTracker.DeviceInfo}
         */
    ...
    /**
     * Callback which is invoked when the {@link DeviceTracker.DeviceInfo} is finished loading.
     */
    public interface Callback {
         ...
         *
         * @param info
         *     the requested {@link DeviceTracker.DeviceInfo}
         * @param error
